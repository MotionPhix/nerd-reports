...
<template>
    <div v-for="(phone, idx) in phones" :key="idx" class="relative mb-4 space-y-2 rounded-br-xl group first-letter:uppercase">
        ...
        <section class="absolute z-30 items-center hidden h-8 gap-2 px-3 py-1 rounded-lg top-7 dark:bg-gray-800 group-hover:inline-flex bottom-10 right-3">
            <button
                type="button"
