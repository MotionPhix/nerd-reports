...
<template>
    <Combobox
      ...
      <div class="relative mt-1">
        ...
        >
          <ComboboxOptions
            class="absolute w-full py-1 mt-1 overflow-auto text-base bg-white dark:bg-gray-800 rounded-md shadow-lg dark:text-white max-h-60 ring-1 ring-black/5 focus:outline-none sm:text-sm"
          >
            <div
