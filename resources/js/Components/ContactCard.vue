...
import { IconMail, IconMailForward, IconSquareRoundedPlus } from '@tabler/icons-vue';
  ...
  <li
    ...
    <Link
      ...
      <div class="flex-1 min-w-0">
        ...
        <p class="text-2xl font-medium text-gray-900 truncate gap-2 flex items-end text-balance dark:text-white">
    ...
    <div class="relative top-0 right-0 z-20 gap-2 flex items-center justify-end cursor-pointer">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400">
            <Link as="button" href="#">
              <IconMail stroke="2.5" class="w-6 h-6" />
            </Link>
        </p>
