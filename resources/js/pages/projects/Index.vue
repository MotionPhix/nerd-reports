          ...
          <CardContent class="p-6">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ projectStats.total }}</p>
              </div>
          ...
          <CardContent class="p-6">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ projectStats.active }}</p>
              </div>
          ...
          <CardContent class="p-6">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ projectStats.completed }}</p>
              </div>
          ...
          <CardContent class="p-6">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ projectStats.overdue }}</p>
              </div>
        ...
        <CardContent class="space-y-4">
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
              <Button @click="applyFilters" :disabled="isLoading" class="gap-2">
      ...
      <Tabs v-model="activeTab" class="space-y-6">
        ...
        <TabsContent value="all" class="space-y-4">
          <div v-if="filteredProjects.length === 0" class="text-center py-12">
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">No projects found</h3>
          ...
          <div v-else class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <Card v-for="project in filteredProjects" :key="project.uuid" class="hover:shadow-lg transition-shadow">
              <CardHeader class="pb-3">
                <div class="flex items-start justify-between">
                  <div class="flex-1 min-w-0">
                    <CardTitle class="text-lg truncate">
                      <a :href="route('projects.show', project.uuid)" class="hover:text-blue-600 dark:hover:text-blue-400">
                        {{ project.name }}
                      </a>
                    </CardTitle>
                    <CardDescription class="mt-1">
                      {{ project.contact.full_name }}
                      <span v-if="project.contact.firm" class="text-xs">
                ...
                <div class="flex items-center gap-2 mt-2">
                  <Badge :class="getStatusColor(project.status)" class="gap-1">
                    <component :is="getStatusIcon(project.status)" class="h-3 w-3" />
                    {{ project.status.replace('_', ' ') }}
                  </Badge>

                  <Badge v-if="isOverdue(project)" variant="destructive" class="gap-1">
              ...
              <CardContent class="space-y-4">
                ...
                <div class="grid grid-cols-3 gap-3 text-center">
                  <div class="p-2 bg-gray-50 dark:bg-gray-800 rounded">
                    <div class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ project.stats.total_hours }}</div>
                    <div class="text-xs text-muted-foreground">Hours</div>
                  </div>
                  <div class="p-2 bg-gray-50 dark:bg-gray-800 rounded">
                    <div class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ project.stats.overdue_tasks }}</div>
                    <div class="text-xs text-muted-foreground">Overdue</div>
                  </div>
                  <div class="p-2 bg-gray-50 dark:bg-gray-800 rounded">
                    <div class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ project.stats.completion_rate }}%</div>
        ...
        <TabsContent value="active">
          <div v-if="filteredProjects.length === 0" class="text-center py-12">
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">No active projects</h3>
            <p class="text-muted-foreground mb-4">All your projects are either completed or not yet started.</p>
          </div>
          <div v-else class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <!-- Same project cards as above -->
            <Card v-for="project in filteredProjects" :key="project.uuid" class="hover:shadow-lg transition-shadow">
              <!-- Same content as above project card -->
            </Card>
          </div>
        </TabsContent>
        ...
        <TabsContent value="overdue">
          <div v-if="filteredProjects.length === 0" class="text-center py-12">
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">No overdue projects</h3>
          ...
          <div v-else class="space-y-4">
            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <!-- Same project cards as above -->
              <Card v-for="project in filteredProjects" :key="project.uuid" class="hover:shadow-lg transition-shadow border-red-200 dark:border-red-800">
                <!-- Same content as above project card -->
              </Card>
            </div>
          </div>
        ...
        <TabsContent value="completed">
          <div v-if="filteredProjects.length === 0" class="text-center py-12">
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">No completed projects</h3>
        ...
        <TabsContent value="recent">
          <div v-if="filteredProjects.length === 0" class="text-center py-12">
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">No recent activity</h3>
