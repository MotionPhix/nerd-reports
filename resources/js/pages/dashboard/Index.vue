  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    <div class="p-6 space-y-8">
      ...
      <div v-if="hasAlerts" class="grid gap-4 md:grid-cols-3">
        <Alert v-if="dashboardData.overview?.tasks?.overdue > 0" variant="destructive" class="border-red-200 dark:border-red-800">
          ...
          <AlertDescription class="mt-2">
            ...
            >
              View Tasks <ArrowRight class="h-3 w-3" />
            </Link>
          </AlertDescription>
        </Alert>

        <Alert v-if="dashboardData.overview?.projects?.overdue > 0" variant="destructive" class="border-red-200 dark:border-red-800">
          <IconAlertTriangle class="h-4 w-4" />
          <AlertTitle class="flex items-center justify-between">
            Overdue Projects
            <Badge variant="destructive" class="ml-2">
        ...
        <Alert v-if="dashboardData.overview?.interactions?.follow_ups_overdue > 0" variant="destructive" class="border-red-200 dark:border-red-800">
          <IconAlertTriangle class="h-4 w-4" />
          <AlertTitle class="flex items-center justify-between">
            Overdue Follow-ups
            <Badge variant="destructive" class="ml-2">
          ...
          <AlertDescription class="mt-2">
            ...
            <Link
              ...
              class="inline-flex items-center gap-1 mt-2 text-sm font-medium text-red-600 hover:text-red-500 dark:text-red-400 dark:hover:text-red-300"
            >
              View Follow-ups <ArrowRight class="h-3 w-3" />
            </Link>
          </AlertDescription>
        </Alert>
      </div>
        ...
        <Card class="lg:col-span-2">
          ...
          <CardContent>
            <div class="space-y-4">
              ...
              <div v-else v-for="activity in dashboardData.recent_activity?.slice(0, 5)" :key="activity.timestamp" class="flex items-start gap-3 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
          ...
          <CardContent>
            <div class="space-y-4">
              ...
              <div v-if="dashboardData.interactions?.today_follow_ups?.length > 0">
                ...
                <div class="space-y-2">
                  <div v-for="followUp in dashboardData.interactions.today_follow_ups.slice(0, 3)" :key="followUp.uuid" class="flex items-center gap-2 p-2 rounded-md bg-yellow-50 dark:bg-yellow-900/20">
                    <Bell class="h-4 w-4 text-yellow-600" />
                    <div class="flex-1 min-w-0">
                      <p class="text-sm font-medium truncate">{{ followUp.contact.first_name }} {{ followUp.contact.last_name }}</p>
              ...
              <div v-if="dashboardData.upcoming?.tasks?.length > 0">
                ...
                <div class="space-y-2">
                  <div v-for="task in dashboardData.upcoming.tasks.slice(0, 3)" :key="task.uuid" class="flex items-center gap-2 p-2 rounded-md bg-blue-50 dark:bg-blue-900/20">
        ...
        <Card>
          ...
          <CardContent>
            <div class="space-y-4">
              ...
              <div v-else v-for="project in dashboardData.projects.active.slice(0, 4)" :key="project.uuid" class="border rounded-lg p-4 hover:shadow-md transition-shadow">
        ...
        <Card>
          ...
          <CardContent>
            <div class="space-y-4">
              ...
              <div v-else v-for="interaction in dashboardData.interactions.recent.slice(0, 4)" :key="interaction.uuid" class="border rounded-lg p-4 hover:shadow-md transition-shadow">
      ...
      <!-- Overdue Items Alert -->
      <div v-if="dashboardData.tasks?.overdue?.length > 0 || dashboardData.projects?.overdue?.length > 0" class="space-y-4">
          ...
          <CardContent>
            <div class="grid gap-4 md:grid-cols-2">
              ...
              <div v-if="dashboardData.tasks?.overdue?.length > 0">
                ...
                <div class="space-y-2">
                  <div v-for="task in dashboardData.tasks.overdue.slice(0, 3)" :key="task.uuid" class="flex items-center gap-2 p-2 rounded-md bg-red-50 dark:bg-red-900/20">
              ...
              <div v-if="dashboardData.projects?.overdue?.length > 0">
                ...
                <div class="space-y-2">
                  <div v-for="project in dashboardData.projects.overdue.slice(0, 3)" :key="project.uuid" class="flex items-center gap-2 p-2 rounded-md bg-red-50 dark:bg-red-900/20">
                    <IconAlertTriangle class="h-4 w-4 text-red-600" />
                    <div class="flex-1 min-w-0">
      ...
      <!-- Weekly Summary -->
      <Card v-if="dashboardData.reports?.last_weekly_report" class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/50 dark:to-indigo-950/50 border-blue-200 dark:border-blue-800">
        <CardHeader>
        ...
        <CardContent>
          ...
          <div class="flex items-center justify-between mt-4 pt-4 border-t border-blue-200 dark:border-blue-700">
            <div class="text-sm text-blue-700 dark:text-blue-300">
              Week {{ dashboardData.reports.last_weekly_report.week_number }}, {{ dashboardData.reports.last_weekly_report.year }}
            </div>
            <Button variant="outline" size="sm" as="a" :href="route('reports.show', dashboardData.reports.last_weekly_report.uuid)">
              <Eye class="h-4 w-4 mr-1" />
              View Full Report
            </Button>
          </div>
